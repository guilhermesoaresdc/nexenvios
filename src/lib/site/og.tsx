 ...
 *
 * Mora em `lib` e não numa rota porque precisa valer em MAIS DE UMA. A
 * convenção de arquivo do Next resolve por segmento: com o gerador só na
 * raiz, `/termos` e `/privacidade` saíam sem `og:image` — elas declaram o
 * próprio `openGraph`, e isso substitui o da raiz inteiro em vez de somar.
 */
